...
def quiz():
    ...
    if quizform.validate_on_submit():
        ...
        #Question 2
        if( quizform.question2.data).lower() == "crux":
        ...
        #Question 3
        if( quizform.question3.data).lower() == "Aquarius":
        ...
        #Question 4
        if( quizform.question4.data).lower() == "Orion":
        ...
        #Question 5
        if( quizform.question5.data).lower() == "Centaurus":
        ...
        #Question 7
        if( quizform.question7.data).lower() == "Sagittarius":
        ...
        #Question 8
        if( quizform.question8.data).lower() == "Scorpius":
        ...
        #Question 9
        if( quizform.question9.data).lower() == "Canis Major":
        ...
        #Question 10
        if (quizform.question10.data).lower() == "Alpha Centauri":
